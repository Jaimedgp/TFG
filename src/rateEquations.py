...
alpha = 0.0 # linewidth engancement factor
...
#        dT
tmp = 2 * np.pi * tIntev * -28.3905674923444#-47.0349688770657#-28.3905674923444#*dfdT * tempIntev
...
print fftTime[np.where(TFprom == max(TFprom))][0]
